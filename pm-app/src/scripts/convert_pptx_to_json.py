    ...
    try:
        with zipfile.ZipFile(pptx_path, 'r') as zip_ref:
            ...
            with zip_ref.open(slide_path) as slide_file:
                ...
                fonts_and_sizes = {"title": {"font": None, "size": None}, "content": {"font": None, "size": None}}
                ...
                print(f"  Debug - Fonts and sizes from slide{slide_num}.xml: {fonts_and_sizes}")
...
def get_font_info(paragraph, shape=None, slide=None, prs=None, pptx_path=None):
    ...
    if pptx_path and slide:
        ...
        if slide_data:
            ...
            if font_name or font_size:
                print(f"  Debug - Fallback to slide{slide_num}.xml: Font: {font_name}, Size: {font_size}")
                return font_name, font_size
    ...
    if pptx_path:
        ...
        if theme_fonts:
            ...
            print(f"  Debug - Fallback to theme: Font: {font_name}, Size: {font_size}")
            return font_name, font_size
    
    print(f"  Debug - No font or size found for '{paragraph.text.strip()}'")
    return None, None
            ...
            for i, slide in enumerate(prs.slides):
                ...
                for shape in slide.shapes:
                    ...
                    for paragraph in shape.text_frame.paragraphs:
                        ...
                        font_name, font_size = get_font_info(paragraph, shape, slide, prs, pptx_path=file_path)
                ...
                # Gán font và size từ theme nếu vẫn null
                if content:
